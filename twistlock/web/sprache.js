...
de:{
  ...
  ankunftUnzuverlaessig:"Ankunft derzeit nicht zuverlässig",
  ortungFehlt:"Es fehlt eine aktuelle Ortung.",
  prognoseAlt:"Die Ankunftsberechnung ist zu alt.",
  gespeichertAufGeraet:"Auf dem Gerät gespeichert – wird später gesendet",
  uebertragungOffen:"Übertragung offen",
  uebertragungBestaetigt:"Übertragung bestätigt",
  fotoNichtGespeichert:"Foto noch nicht gespeichert. Bitte erneut versuchen.",
  erneutSpeichern:"Erneut speichern", zurueckZumFoto:"Zurück zum Foto",
  speicherFehlerText:"Das Foto ist noch da. Solange es nicht gespeichert ist, gilt der Schritt als offen.",
  keinVorgangOffen:"Es wartet kein Vorgang",
  demoNichtGesendet:"Demo: nicht wirklich gesendet",
  verlassenWarnung:"Das Foto ist noch nicht gespeichert.",
...
tr:{
  ...
  ankunftUnzuverlaessig:"Varış şu an güvenilir değil",
  ortungFehlt:"Güncel bir konum yok.",
  prognoseAlt:"Varış hesabı çok eski.",
  gespeichertAufGeraet:"Cihaza kaydedildi – daha sonra gönderilecek",
  uebertragungOffen:"Gönderim bekliyor",
  uebertragungBestaetigt:"Gönderim onaylandı",
  fotoNichtGespeichert:"Fotoğraf henüz kaydedilmedi. Lütfen tekrar dene.",
  erneutSpeichern:"Tekrar kaydet", zurueckZumFoto:"Fotoğrafa dön",
  speicherFehlerText:"Fotoğraf duruyor. Kaydedilmediği sürece adım açık sayılır.",
  keinVorgangOffen:"Bekleyen kayıt yok",
  demoNichtGesendet:"Demo: gerçekte gönderilmedi",
  verlassenWarnung:"Fotoğraf henüz kaydedilmedi.",
...
pl:{
  ...
  ankunftUnzuverlaessig:"Przyjazd obecnie niepewny",
  ortungFehlt:"Brak aktualnej lokalizacji.",
  prognoseAlt:"Obliczenie przyjazdu jest za stare.",
  gespeichertAufGeraet:"Zapisano na urządzeniu – wyśle się później",
  uebertragungOffen:"Wysyłka oczekuje",
  uebertragungBestaetigt:"Wysyłka potwierdzona",
  fotoNichtGespeichert:"Zdjęcie jeszcze nie zapisane. Spróbuj ponownie.",
  erneutSpeichern:"Zapisz ponownie", zurueckZumFoto:"Wróć do zdjęcia",
  speicherFehlerText:"Zdjęcie jest nadal tutaj. Dopóki nie zostanie zapisane, krok pozostaje otwarty.",
  keinVorgangOffen:"Nic nie czeka",
  demoNichtGesendet:"Demo: naprawdę nie wysłano",
  verlassenWarnung:"Zdjęcie nie jest jeszcze zapisane.",
...
ro:{
  ...
  ankunftUnzuverlaessig:"Sosirea nu este de încredere acum",
  ortungFehlt:"Lipsește o localizare actuală.",
  prognoseAlt:"Calculul sosirii este prea vechi.",
  gespeichertAufGeraet:"Salvat pe dispozitiv – se trimite mai târziu",
  uebertragungOffen:"Trimitere în așteptare",
  uebertragungBestaetigt:"Trimitere confirmată",
  fotoNichtGespeichert:"Poza nu este încă salvată. Te rog încearcă din nou.",
  erneutSpeichern:"Salvează din nou", zurueckZumFoto:"Înapoi la poză",
  speicherFehlerText:"Poza este încă aici. Cât timp nu este salvată, pasul rămâne deschis.",
  keinVorgangOffen:"Nu așteaptă nimic",
  demoNichtGesendet:"Demo: nu s-a trimis cu adevărat",
  verlassenWarnung:"Poza nu este încă salvată.",
...
ar:{
  ...
  ankunftUnzuverlaessig:"الوصول غير موثوق الآن",
  ortungFehlt:"لا يوجد تحديد موقع حديث.",
  prognoseAlt:"حساب الوصول قديم جداً.",
  gespeichertAufGeraet:"محفوظة على الجهاز – سترسل لاحقاً",
  uebertragungOffen:"الإرسال معلّق",
  uebertragungBestaetigt:"تم تأكيد الإرسال",
  fotoNichtGespeichert:"لم تُحفظ الصورة بعد. من فضلك حاول مرة أخرى.",
  erneutSpeichern:"احفظ مرة أخرى", zurueckZumFoto:"عد إلى الصورة",
  speicherFehlerText:"الصورة ما زالت هنا. ما دامت غير محفوظة تبقى الخطوة مفتوحة.",
  keinVorgangOffen:"لا يوجد إجراء منتظر",
  demoNichtGesendet:"عرض توضيحي: لم يُرسل فعلياً",
  verlassenWarnung:"الصورة غير محفوظة بعد.",
