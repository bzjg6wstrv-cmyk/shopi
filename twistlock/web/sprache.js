...
de:{
  ...
  speicherFehlerText:"Das Foto ist noch da. Solange es nicht gespeichert ist, gilt der Schritt als offen. Ein noch nicht gespeichertes Foto kann beim Schließen verloren gehen.",
  ...
  nichtSchliessen:"Bitte diese Seite nicht schließen.",
...
tr:{
  ...
  speicherFehlerText:"Fotoğraf duruyor. Kaydedilmediği sürece adım açık sayılır. Kaydedilmemiş bir fotoğraf kapatınca kaybolabilir.",
  ...
  nichtSchliessen:"Lütfen bu sayfayı kapatma.",
...
pl:{
  ...
  speicherFehlerText:"Zdjęcie jest nadal tutaj. Dopóki nie zostanie zapisane, krok pozostaje otwarty. Niezapisane zdjęcie może zniknąć po zamknięciu.",
  ...
  nichtSchliessen:"Proszę nie zamykać tej strony.",
...
ro:{
  ...
  speicherFehlerText:"Poza este încă aici. Cât timp nu este salvată, pasul rămâne deschis. O poză nesalvată se poate pierde la închidere.",
  ...
  nichtSchliessen:"Te rog nu închide această pagină.",
...
ar:{
  ...
  speicherFehlerText:"الصورة ما زالت هنا. ما دامت غير محفوظة تبقى الخطوة مفتوحة. قد تُفقد الصورة غير المحفوظة عند الإغلاق.",
  keinVorgangOffen:"لا يوجد إجراء منتظر",
  demoNichtGesendet:"عرض توضيحي: لم يُرسل فعلياً",
  verlassenWarnung:"الصورة غير محفوظة بعد.",
  nichtSchliessen:"من فضلك لا تغلق هذه الصفحة.",
